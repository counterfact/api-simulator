...
A Counterfact sandbox is running at http://127.0.0.1:61449. You may make real HTTP requests to it. Select a deterministic behavior with POST /control/reset and JSON {"scenario":"SCENARIO"}; available scenarios are happy, rate-limit, transient-503, permanent-429, and bad-request. Inspect GET /control/stats when useful. Exercise the sandbox before finishing.
